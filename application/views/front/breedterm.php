 ...
 <!-- Header -->     
    ...
    <section class="section-03">
        <div class="container">
           ...
           <?php echo form_open('/breed/breed_pay_info'); ?>
            <div class="row md-space">   

                 <?php echo $terms_conditions =  $this->db->get_where('general_settings',array('type' => 'terms_conditions_breeding'))->row()->value; ?>                         
                ...
                <input type="hidden" name="femalehoseid" value="<?php echo $femalehoseid; ?>" />
                <input type="hidden" name="malehoseid" value="<?php echo $malehoseid; ?>" />
                    <input type="checkbox" id="myCheck" class="term-check required tccheck" name="agree" />* I Agree with terms and conditions
                    <input type="submit" value="Submit" onClick="return check();" name="name_agr" class="term-button subbtn">
