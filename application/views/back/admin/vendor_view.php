                    ...
                    <?php 
                                    ...
                                    ?>
                                        <div class="delete-div-wrap">
                                            <div class="inner-div">
                                                <img class="img-responsive" width="100" src="<?php echo $images; ?>" onerror="this.src='<?php echo base_url(); ?>template/back/img/av1.png'"  alt="vendor_Image" >
                                            </div>
                                        </div>
            </div>
        ...
        <div class="col-sm-12">
            <div class="panel-body">
                <table class="table table-striped" style="border-radius:3px;">
                    ...
                    <tr>
                        <th class="custom_td"><?php echo translate('username');?></th>
                        <td class="custom_td"><?php echo $row['username'];?></td>
                    </tr>
                    <tr>
