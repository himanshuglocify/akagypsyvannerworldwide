                    ...
                    <div class="tab-content">
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            <button class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right" 
                                onclick="ajax_set_full('add','<?php echo translate('add_horse'); ?>','<?php echo translate('successfully_added!'); ?>','product_add',''); proceed('to_list');"><?php echo translate('add_horse');?>
                            </button>
                        ...
                        <div><a href="<?php echo base_url(); ?>index.php/home/vendor_list" target="new"><p style="color:#A91E1E;"><strong>See Horses by Vendors</strong></p></a></div> 
                        </div>
                    <!-- LIST -->
