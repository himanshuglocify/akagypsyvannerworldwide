    ...
    <div class="col-md-12">
        ...
        ?>
            ...
            <div class="panel-body">
                ...
                <div class="tab-base">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-2"><?php echo translate('name');?></label>
                                <div class="col-sm-6">
							...
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-3"><?php echo translate('surname');?></label>
                                <div class="col-sm-6">
                                    <input type="text" value="<?php echo $row['surname']; ?>" name="surname" id="demo-hor-3" placeholder="<?php echo translate('surname');?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    ?>
                                        <div class="delete-div-wrap">
                                            ...
                                            <div class="inner-div">
                                                <img class="img-responsive" width="100" src="<?php echo $images; ?>"  alt="vendor_Image" >
                                            </div>
                                        </div>
                                    <?php 
                             ...
                             <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="company" value="<?php echo $row['company']; ?>"   placeholder="<?php echo translate('company');?>" class="form-control required">
                                </div>
                            </div>
							...
							<div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
									 ...
									 <option value="<?php echo $membership['membership_id']; ?>" <?php if($membership['membership_id'] == $row['membership']){echo 'selected="selected"';} ?>><?php echo 'Title :'.$membership['title'].' ,&nbsp;Price : '.$membership['price'].' ,&nbsp;Time :  '.$membership['timespan']; ?></option>
									 <?php } ?>
                                ...
                                <div class="col-sm-6">
                                     <select name="gender" class="demo-chosen-select required"  data-placeholder="Choose Gender " tabindex="2" >
                                         <option value="male" <?php if('male' == $row['gender']){echo 'selected="selected"';} ?>>Male</option>
                                         <option value="female" <?php if('female' == $row['gender']){echo 'selected="selected"';} ?>>Female</option>
                                     </select>
                                </div>
                            </div>                     
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="phone" value="<?php echo $row['phone']; ?>"  id="demo-hor-5" placeholder="<?php echo translate('phone');?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="address1" value="<?php echo $row['address1']; ?>"  id="demo-hor-7" placeholder="<?php echo translate('address1');?>" class="form-control required">
                                </div>
                            </div>
							<div class="form-group btm_border">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="address2"  value="<?php echo $row['address2']; ?>" id="demo-hor-8" placeholder="<?php echo translate('address2');?>" class="form-control required">
                                </div>
                            </div>
							 ...
							 <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="paypal_email" value="<?php echo $row['paypal_email']; ?>"  class="form-control required" placeholder="<?php echo translate('paypal_email');?>"> 
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-10"><?php echo translate('zip');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="zip" value="<?php echo $row['zip']; ?>"  id="demo-hor-10" placeholder="<?php echo translate('zip');?>" class="form-control required">
                                </div>
                            </div>
            ...
            <div class="panel-footer">
                <div class="row">
                	<div class="col-md-12">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('vendor_edit','<?php echo translate('vendor_has_been_uploaded!'); ?>');proceed('to_add');" ><?php echo translate('update');?></span>
                    </div>
