<div class="row">
    ...
    <?php foreach($user_data as $row)
            ...
            ?>
      <?php
            echo form_open(base_url() . 'index.php/admin/widget/update/' . $row['widget_id'], array(
        ...
        ?>
            ...
            <div class="panel-body">
                ...
                <div class="tab-base">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="widget_title" id="demo-hor-1" value="<?php echo $row['name'];?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                <div class="abstract">
                                    <textarea rows="9"  class="summernotes" data-height="400" data-name="widget_content" name="widget_content"><?php echo $row['content'];?></textarea>
                                   </div> 
                                </div>
                            </div>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('widget_edit','<?php echo translate('widget_has_been_uploaded!'); ?>');proceed('to_add');" ><?php echo translate('update');?></span>
                    </div>
