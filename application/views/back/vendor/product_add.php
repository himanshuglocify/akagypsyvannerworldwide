    ...
    <div class="col-md-12">
        ...
        ?>
                    ...
                    <div class="tab-content">
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="sale_price" id="demo-hor-6" min='0' step='.01' placeholder="<?php echo translate('price');?>" value="0" class="form-control">
                                </div>
                                ...
                                <div class="col-sm-6">
								<select name="country" id="country" class="form-control required" onChange="getState(this);">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="city" id="demo-hor-9" value="<?php echo $user_data['city']; ?>" placeholder="<?php echo translate('city');?>" class="form-control required">
                                </div>
                            </div>                            
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="zipcode" id="demo-hor-10" value="<?php echo $user_data['zip']; ?>" placeholder="<?php echo translate('zip_code');?>" class="form-control required">
                                </div>
                            </div>   
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="address" id="demo-hor-20" value="<?php echo $user_data['address1']; ?>" placeholder="<?php echo translate('address');?>" class="form-control required">
                                </div>
                            </div> 
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="address1" id="demo-hor-21" value="<?php echo $user_data['address2']; ?>" placeholder="<?php echo translate('address_1');?>" class="form-control">
                                </div>
                            </div>
			...
			<div class="panel-footer">
                    ...
                    <div class="col-md-2">
                        ...
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
								...
								<div class="col-sm-6">
									<input type="text" value="" name="color" placeholder="<?php echo translate('color');?>" class="form-control required" />
								</div>
                            </div>
                ...
                <span id="next_btn" class="btn btn-purple btn-labeled fa fa-arrow-right pull-right" onclick="next_tab()"><?php echo translate('next'); ?></span>
                <span id="previous_btn" class="btn btn-purple btn-labeled fa fa-arrow-left pull-right" onclick="previous_tab()"><?php echo translate('previous'); ?></span>
...
function getState(arg)
    ...
    */
	...
	$(document).ready(function(){
		...
		var country_id = <?php echo $user_data['country']; ?>;
		$('#country').val(country_id).trigger('change');
		var state_id = <?php echo $user_data['state']; ?>;
