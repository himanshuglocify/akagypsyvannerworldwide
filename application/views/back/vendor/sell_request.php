 <div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow"><?php echo translate('sell_request');?></h1>
	</div>
        <div class="tab-base">
            <div class="panel">
                    ...
                    <div class="tab-content">
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            <button class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right" 
                                onclick="ajax_set_full('send','<?php echo translate('send_request'); ?>','<?php echo translate('successfully_sent!'); ?>','sell_request_send',''); proceed('to_list');"><?php echo translate('send_request');?>
                            </button>
