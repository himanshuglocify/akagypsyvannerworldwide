                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">'
								...
								<div class="col-sm-6">
									<input type="text" value="<?php echo $row['color']; ?>" name="color" placeholder="<?php echo translate('color');?>" class="form-control required" />
								</div> 
                            </div>		
                            <div class="form-group btm_border">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="date_of_birth" value="<?php echo $row['date_of_birth']; ?>" id="demo-hor-32" placeholder="<?php echo translate('date_of_birth');?>" class="form-control required">
                                </div>
                            </div>	
                        ...
                        <div id="business_details" class="tab-pane fade">
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="sale_price" id="demo-hor-6" min='0' step='.01' value="<?php echo $row['sale_price']; ?>" disabled="disabled" placeholder="<?php echo translate('price');?>" class="form-control">
                                </div>
